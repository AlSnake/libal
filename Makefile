...
export MAKE_DIR CC LD CFLAGS LDFLAGS LIBS INC_SRCH_PATH LIB_SRCH_PATH OBJ_DIR LIB_DIR BIN_DIR BUILD_DIR
...
clangformat:
	clang-format -i $(SRC_DIR)/*/*.c $(SRC_DIR)/*/*.h $(INCLUDE_DIR)/*/*.h $(TEST_DIR)/*.c $(TEST_DIR)/*.h
